...
dv = pickle.loads(
    s3.Bucket(MLFLOW_S3_BUCKET)
    .Object(f"2/{best_run_id}/artifacts/preprocessor/preprocessor.b")
    .get()["Body"]
    .read()
)
...
def predict(features):
    ...
    if pred_class:
        return_string = (
            f"Delayed! There is a {pred:.2%} chance your flight will be delayed."
        )
    else:
        return_string = (
            f"On time! There is a {pred:.2%} chance your flight will be delayed."
        )
